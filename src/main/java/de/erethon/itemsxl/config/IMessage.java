...
public enum IMessage implements Message {
    ...
    ERROR_RECIPE_NOT_FOUND("error.recipeNotFound"),
    ...
    COMMAND_UNREGISTER_RECIPE_SUCCESS("command.unregisterRecipe.success"),
    HELP_GIVE("help.give"),
    HELP_HELP("help.help"),
    HELP_INFO("help.info"),
    HELP_LIST("help.list"),
    ...
    HELP_UNREGISTER_RECIPE("help.unregisterRecipe"),
    ...
    EDITOR_ERRONEOUS_ITEM_NAME("editor.erroneousItemName"),
    EDITOR_ERRONEOUS_ITEM_LORE("editor.erroneousItemLore"),
